...
# Skip tests - requires langchain_core or similar optional dependency
try:
    from app.services.langgraph.agents.qualification_agent import QualificationAgent
except (ImportError, ModuleNotFoundError) as e:
    if "langchain" in str(e) or "langgraph" in str(e):
        pytest.skip("langchain_core or similar dependency not available", allow_module_level=True)
    raise
