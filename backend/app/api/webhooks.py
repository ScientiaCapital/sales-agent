...
Note: Close CRM and Apollo webhooks are in the app.api.webhooks package.
...
# Apollo webhooks are in app.api.webhooks.apollo
...
async def webhook_health():
    """Health check for Slack webhook endpoints."""
